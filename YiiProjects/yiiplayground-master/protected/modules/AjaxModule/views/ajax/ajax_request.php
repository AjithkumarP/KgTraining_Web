...
<div id="maindiv">
    ...
    <div class="demo_box">
        ...
        Yii::app()->sc->collect('php', Yii::app()->sc->getFunctionFromFile(
                        'public function actionReqTest01', 'protected/modules/AjaxModule/controllers/AjaxController.php'
                ), false, true);
        ?>
    </div><!-- demo box -->
    ...
    <div class="demo_box">
        ...
        Yii::app()->sc->collect('php', Yii::app()->sc->getSourceToLine(__LINE__, __FILE__));
        Yii::app()->sc->collect('php', Yii::app()->sc->getFunctionFromFile(
                        'public function actionReqTest01Loading', 'protected/modules/AjaxModule/controllers/AjaxController.php'
                ), false, true);
        ?>
    </div><!-- demo box -->
    <?php Yii::app()->sc->renderSourceBox(); ?>
    ...
    <div class="demo_box">
        ...
        <div class="form">
            ...
            echo CHtml::ajaxSubmitButton(
                    'Submit request', array('ajax/reqTest03'), array(
                'update' => '#req_res02',
                    )
            );
            ?>
        ...
        Yii::app()->sc->collect('php', Yii::app()->sc->getSourceToLine(__LINE__, __FILE__));
        Yii::app()->sc->collect('php', Yii::app()->sc->getFunctionFromFile(
                        'public function actionReqTest03', 'protected/modules/AjaxModule/controllers/AjaxController.php'
                ), false, true);
        ?>
    </div><!-- demo box -->
