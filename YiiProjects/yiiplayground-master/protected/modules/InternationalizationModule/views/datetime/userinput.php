...
<div class="demo_box">
    ...
    <div class="form">
        ...
        <div class="row">
            ...
            <?php echo CHtml::dropdownList('c_time_min', false, array('00' => '00', '15' => '15', '30' => '30', '45' => '45'));
            ?>
        </div>
        <div class="row">
            ...
            <?php echo CHtml::dropdownList('c_datetime_min', false, array('00' => '00', '15' => '15', '30' => '30', '45' => '45'));
            ?>
        </div>

        <?php echo CHtml::hiddenField('item_id', 0); ?>
        <?php echo CHtml::ajaxButton('Save', $this->createUrl('userinputSave'), array('type' => 'POST', 'success' => 'formSaved'), array('disabled' => "disabled", 'id' => 'save_btn'));
        ?>
    ...
    Yii::app()->sc->collect('php', Yii::app()->sc->getFunctionFromFile(
                    'public function actionUserinputData', 'protected/modules/InternationalizationModule/controllers/DatetimeController.php'
            ), false, true);
    Yii::app()->sc->collect('php', Yii::app()->sc->getFunctionFromFile(
                    'public function actionUserinputSave', 'protected/modules/InternationalizationModule/controllers/DatetimeController.php'
            ), false, true);
    ?>
</div><!-- demo box -->
