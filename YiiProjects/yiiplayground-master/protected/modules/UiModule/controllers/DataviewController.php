...
class DataviewController extends Controller {
    ...
    public function actionGridView() {
        ...
        if (!isset($_GET['ajax']))
            $this->render('grid_view', $params);
        else
            $this->renderPartial('grid_view', $params);
    }
    ...
    public function actionGridViewArray() {
        ...
        if (!isset($_GET['ajax']))
            $this->render('grid_view_array', $params);
        else
            $this->renderPartial('grid_view_array', $params);
    }
    ...
    public function actionGridStyle() {
        ...
        if (!isset($_GET['ajax']))
            $this->render('grid_style', $params);
        else
            $this->renderPartial('grid_style', $params);
    }
