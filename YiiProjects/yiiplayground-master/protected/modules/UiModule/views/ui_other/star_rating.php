...
<div class="demo_box">
    ...
    Yii::app()->sc->collect('php', Yii::app()->sc->getFunctionFromFile(
                    'public function actionStarRating', 'protected/modules/UiModule/controllers/Ui_otherController.php'
            ), false, true);
    ?>
</div><!-- demo box -->
...
//because we are activating CSRF and se using POST, we must give token to the AJAX Parameter
    ...
    Yii::app()->sc->collect('php', Yii::app()->sc->getSourceToLine(__LINE__, __FILE__));
    Yii::app()->sc->collect('php', Yii::app()->sc->getFunctionFromFile(
                    'public function actionStarRatingAjax', 'protected/modules/UiModule/controllers/Ui_otherController.php'
            ), false, true);
    ?>
</div><!-- demo box -->
