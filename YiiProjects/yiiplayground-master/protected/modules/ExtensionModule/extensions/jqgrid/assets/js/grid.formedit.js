        ...
        editGridRow: function (rowid, p) {
            ...
            return this.each(function () {
                ...
                if ($("#" + IDs.themodal).html() != null) {
                    ...
                    $("#sData", "#" + frmtb).click(function (e) {
                        ...
                        if ($.isFunction(rp_ge.onclickSubmit)) {
                            rp_ge.editData = rp_ge.onclickSubmit(p) || {};
                        }
                        if (ret[0]) {
                ...
                function updateNav(cr, totr, rid) {
                    if (cr == 0) {
                        $("#pData", "#" + frmtb).addClass('ui-state-disabled');
                    } else {
                        $("#pData", "#" + frmtb).removeClass('ui-state-disabled');
                    }
                    if (cr == totr) {
                        $("#nData", "#" + frmtb).addClass('ui-state-disabled');
                    } else {
                        $("#nData", "#" + frmtb).removeClass('ui-state-disabled');
                    }
                }
                function getCurrPos() {
