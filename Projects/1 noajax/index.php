        ...
        <div class="w3-container w3-responsive w3-mobile w3-animate-opacity">
            ...
            <form action='db.php' method='post'>
                ...
                <table class='w3-table-all w3-card-4 w3-small '>
                    ...
                    <tr>
                        <td><input style='width:100%;' type='text' class='textinput' name='uname' placeholder='your name' id='uname' required autofocus/></td>
                        <td><input style='width:100%;' type='text' class='textinput' name='uage' placeholder='your age' id='uage' required/></td>
                        <td><input style='width:100%;' type='text' class='textinput' name='uphone' placeholder='your phone number' id='uphone' required/></td>
                    </tr>

                    <tr>
                        <td><input class='w3-button w3-hover-red' style='width:100%; color:red' type='button' onclick='reset()' value='reset'/></td>
                        <td></td>
                        <td><input class='w3-button w3-hover-green'style='width:100%; color:green' type='submit' value='submit'/></td>
                    </tr>
